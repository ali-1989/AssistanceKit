...
class TimerTask {
	...
	TimerTask(this.wait, {String? name}) : name = name?? GeneratorAssistance.generateAlphabet(12);

	TimerTask.byAction(this.wait, this.action, {String? name}) : name = name?? GeneratorAssistance.generateAlphabet(8);
