...
// Project imports:
import 'package:assistance_kit/api/assistance/clone_assistance.dart';

class JsonAssistance {
  JsonAssistance._();
  ...
  static Map<I,J> updateMapCopy<I,J>(Map<I, J>? src, I key, J value){
    ...
    //final res = clone(src);
    final res = CloneAssistance.cloneShallow(src);
  ...
  static Map<String, dynamic>? getMapInListOfMap(List<Map<String, dynamic>> data, {required String key, required dynamic value}) {
    try{
  ...
  static List<Map<String, dynamic>> getItemsInListOfMap(List<Map<String, dynamic>> data, {required String key, required dynamic value}) {
    try{
