...
class ListAssistance {
  ListAssistance._();

  /// stringToStringList('{12, 14}'); ==> ['12', '14']
  ...
  static bool itemIsListOf<T>(dynamic item){
    return item is List && item.isNotEmpty && item.first is T;
  }
}