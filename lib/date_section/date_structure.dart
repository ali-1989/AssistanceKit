...
part 'date_structure_p1.dart';
part 'date_structure_p2.dart';
part 'date_structure_p3.dart';
...
abstract class ADateStructure implements Comparable<ADateStructure> {
  ...
  ///------------------------------------------------------------------------------------------
  int _backwardStepInRing(int current, int step, int allCount, bool baseIsOne) {
    int def, r;
