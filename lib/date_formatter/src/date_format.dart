// Project imports:
import 'locale/date_locale.dart';
import 'locale/english.dart';

export 'locale/date_locale.dart';
...
class DF{
  ...
  static String formatDate(DateTime date, List<String> formats, {DateLocale locale = const EnglishLocale()}) {
